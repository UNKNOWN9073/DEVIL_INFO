...
def login():
	os.system("clear")
	cetak(nel(f'   {P2}Login Cookies First Bro\n\n              {H2}--[ Mr.Robot ]--',title=f'{P2} {H2}[ {P2}🌺Assalamu Alaikum🌺 {H2}]',width=54,padding=(1,4),style='blue'))
	...
	try:
		...
		cetak(nel(f'{P2} TOOLS OWNER Mr.Robot',width=22,style=f"#00FF00"));time.sleep(1.5) 
		login()
